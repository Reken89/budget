...
<table class="freeze-table" width="700px"> 
    ...
    @if ($info['variant'] == '2')
        @include('build.back.buildblock.two')
    @elseif ($info['variant'] == '3')
        @include('build.back.buildblock.three')
    @elseif ($info['variant'] == '4')
        @include('build.back.buildblock.four')
    @elseif ($info['variant'] == '5')
        @include('build.back.buildblock.five')
    @elseif ($info['variant'] == '6')
        @include('build.back.buildblock.six')    
    @endif
