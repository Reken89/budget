            ...
            <div class="container">
                ...
                <div class="shipping__inner style2 d-flex">
                    ...
                    <div class="shipping__items style2 d-flex align-items-center">
                        ...
                        <br>
                        <button style="width:200px;height:50px" name="formSubmit" id="btn_three" class="primary__btn price__filter--btn" type="button">Email</button>
                        </br>
                        ...
                        @if ($info['variant'] == "one")   
                            ...
                            <form id="tarrifs" method="patch">
                                ...
                                <button style="width:200px;height:50px" name="formSubmit" id="btn_four" class="primary__btn price__filter--btn" type="button">Синхронизация</button>
                            </form>                          
                        @endif
                        </div>
                    </div>
