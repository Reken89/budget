...
<table width="700px">             
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ $total['lbo'] }}</td>  
            <td>{{ $total['prepaid'] }}</td>
            <td>{{ $total['credit_year_all'] }}</td>
            <td>{{ $total['credit_year_term'] }}</td>
            <td>{{ $total['debit_year_all'] }}</td>
            <td>{{ $total['debit_year_term'] }}</td>
            <td>{{ $total['fact_all'] }}</td>
            <td>{{ $total['fact_mounth'] }}</td>
            <td>{{ $total['kassa_all'] }}</td>
            <td>{{ $total['kassa_mounth'] }}</td>
            <td>{{ $total['credit_end_all'] }}</td>
            <td>{{ $total['credit_end_term'] }}</td>
            <td>{{ $total['debit_end_all'] }}</td>
            <td>{{ $total['debit_end_term'] }}</td>
            <td>{{ $total['return_old_year'] }}</td>
            <td>{{ $total['total1'] }}</td>
            <td>{{ $total['total2'] }}</td>
        </tr>
    </tbody>
