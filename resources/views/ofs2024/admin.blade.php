        ...
        <section class="my__account--section section--padding">
            ...
            <div class="container">
                ...
                <p><b><u>Сформировать</u></b> - Формирует таблицу, по выбранным параметрам</br>
                    ...
                    <font color='red'>*** Если таблица выходит за пределы рамки, используйте масштабирование страницы, зажмите левый Ctrl и покрутите колесо мышки</font></br>
                </p>
                
                <form id="ofs24" action="/budget/public/admin/ofs2024" method="get">
                                            ...
                                            <div class="single__widget widget__bg">
                                                <ul class="widget__form--check">  
                                                    ...
                                                    <li class="widget__form--check__list">
                                                        ...
                                                        <input id="checkbox" class="widget__form--check__input" name="user[]" value="11" type="checkbox">
                                                        <span class="widget__form--checkmark"></span>
                                                    </li>
                                                    <li class="widget__form--check__list">
                                                        <label class="widget__form--check__label" for="check10">Сказка</label>
                                                        <input id="checkbox" class="widget__form--check__input" name="user[]" value="14" type="checkbox">
                                                        <span class="widget__form--checkmark"></span>
                                                    </li>
                                                    <li class="widget__form--check__list">
...
<script>
    ...
    $(document).ready(function(){ 
        ...
        function fetch_data(){ 
            ...
            $.ajax({  
                url:"/budget/public/admin/ofs2024/table",  
                method:"GET",
                data:{
                    mounth, chapter, user
                },
        ...
        $(document).on('click', '#status', function(){
            ...
            $.ajax({
                url:"/budget/public/admin/ofs2024/status",  
                method:"patch",
                data:{
                    "_token": "{{ csrf_token() }}",
                    chapter, mounth, user
