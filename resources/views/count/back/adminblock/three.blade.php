            ...
            @if ($info['result']['aurinko'][$numb]['ekr']['main'] == 'No' && $info['result']['aurinko'][$numb]['ekr']['number'] == $n)
                <tr>
                    ...
                    <td><input type="hidden" class="shared_id" value="{{ $shared_aurinko_id }}">
                        ...
                        <input type="text" class="sum_fu" value="{{ number_format($info['result']['aurinko'][$numb]['sum_fu'], 2, ',', ' ') }}"></td>
                    ...
                    <td><input type="hidden" class="shared_id" value="{{ $shared_berezka_id }}">
                        ...
                        <input type="text" class="sum_fu" value="{{ number_format($info['result']['berezka'][$numb]['sum_fu'], 2, ',', ' ') }}"></td> 
                    ...
                    <td><input type="hidden" class="shared_id" value="{{ $shared_gnomik_id }}">
                        ...
                        <input type="text" class="sum_fu" value="{{ number_format($info['result']['gnomik'][$numb]['sum_fu'], 2, ',', ' ') }}"></td>  
                    ...
                    <td><input type="hidden" class="shared_id" value="{{ $shared_zoloto_id }}">
                        ...
                        <input type="text" class="sum_fu" value="{{ number_format($info['result']['zoloto'][$numb]['sum_fu'], 2, ',', ' ') }}"></td> 
                    ...
                    <td><input type="hidden" class="shared_id" value="{{ $shared_korablik_id }}">
                        ...
                        <input type="text" class="sum_fu" value="{{ number_format($info['result']['korablik'][$numb]['sum_fu'], 2, ',', ' ') }}"></td> 
                    ...
                    <td><input type="hidden" class="shared_id" value="{{ $shared_skazka_id }}">
                        ...
                        <input type="text" class="sum_fu" value="{{ number_format($info['result']['skazka'][$numb]['sum_fu'], 2, ',', ' ') }}"></td> 
                    ...
                    <td><input type="hidden" class="shared_id" value="{{ $shared_solnce_id }}">
                        ...
                        <input type="text" class="sum_fu" value="{{ number_format($info['result']['solnce'][$numb]['sum_fu'], 2, ',', ' ') }}"></td> 
