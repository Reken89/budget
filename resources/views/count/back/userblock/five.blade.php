...
<table class="freeze-table" width="700px">
        ...
        @for ($numb = 0; $numb < $number; $numb++)
            ...
            @if ($info['result']['school'][$numb]['ekr']['main'] == 'Yes' && $info['result']['school'][$numb]['ekr']['number'] == $n)
                ...
                <tr>
                    ...
                    <td><b><font color="blue">{{ number_format($info['result']['school'][$numb]['sum_fu'], 2, ',', ' ') }}</b></td>
                    <td><b><font color="blue">{{ number_format($info['result']['kinder'][$numb]['sum_fu'], 2, ',', ' ') }}</b></td>                    
                    <td><b><font color="blue">{{ number_format($info['result']['school'][$numb]['sum_fu'] + $info['result']['kinder'][$numb]['sum_fu'], 2, ',', ' ') }}</b></td>
                </tr>
            @endif
            ...
            @if ($info['result']['school'][$numb]['ekr']['main'] == 'No' && $info['result']['school'][$numb]['ekr']['number'] == $n)
                <tr>
                    ...
                    <td><font color="blue">{{ number_format($info['result']['school'][$numb]['sum_fu'], 2, ',', ' ') }}</td>
                    <td><font color="blue">{{ number_format($info['result']['kinder'][$numb]['sum_fu'], 2, ',', ' ') }}</td>
                    <td><font color="blue">{{ number_format($info['result']['school'][$numb]['sum_fu'] + $info['result']['kinder'][$numb]['sum_fu'], 2, ',', ' ') }}</td>
    ...
    <tr>
        ...
        <td><b><font color="blue">{{ number_format($info['total']['school']['sum_fu'], 2, ',', ' ') }}</b></td>
        <td><b><font color="blue">{{ number_format($info['total']['kinder']['sum_fu'], 2, ',', ' ') }}</b></td> 
        <td><b><font color="blue">{{ number_format($info['total']['school']['sum_fu'] + $info['total']['kinder']['sum_fu'], 2, ',', ' ') }}</b></td>
    </tr>
    </tbody>
</table>
