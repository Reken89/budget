...
<table>
    ...
    <tbody>
            ...
            @if(($i % 3) == 0 || $i == 0)
                @if($info['result'][$i]['ekr']['shared'] == "Yes" || $info['result'][$i]['ekr']['main'] == "Yes")
                    <tr>
                        ...
                        <td><b>{{ number_format($info['result'][$i]['sum_fu'] + $info['result'][$i+1]['sum_fu'] + $info['result'][$i+2]['sum_fu'], 2, ',', ' ') }}<b></td>
                        ...
                        <td><font color="{{ $info['color'] }}"><b>{{ number_format($info['result'][$i]['sum_cb'] + $info['result'][$i+1]['sum_cb'] + $info['result'][$i+2]['sum_cb'], 2, ',', ' ') }}<b></td>
                ...
                @else
                    <tr>
                        ...
                        <td>{{ number_format($info['result'][$i]['sum_fu'] + $info['result'][$i+1]['sum_fu'] + $info['result'][$i+2]['sum_fu'], 2, ',', ' ') }}</td>
                        ...
                        <td><font color="{{ $info['color'] }}">{{ number_format($info['result'][$i]['sum_cb'] + $info['result'][$i+1]['sum_cb'] + $info['result'][$i+2]['sum_cb'], 2, ',', ' ') }}</td>
        ...
        <tr>
            <th>Итог</th>
            <td></td>
            <td><b>{{ number_format($info['total'][0]['fu'] + $info['total'][1]['fu'] + $info['total'][2]['fu'], 2, ',', ' ') }}<b></td>
            ...
            <td><font color="{{ $info['color'] }}"><b>{{ number_format($info['total'][0]['cb'] + $info['total'][1]['cb'] + $info['total'][2]['cb'], 2, ',', ' ') }}<b></td>
