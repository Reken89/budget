...
<table>
    ...
    <tbody>
            ...
            @if(($i % 21) == 0 || $i == 0)
                @if($info['result'][$i]['ekr']['shared'] == "Yes" || $info['result'][$i]['ekr']['main'] == "Yes")
                    <tr>
                        ...
                        @endphp     
                        <td><b>{{ number_format($info['result'][$i]['sum_fu'] + $info['result'][$i+1]['sum_fu'] + $info['result'][$i+2]['sum_fu'] + $fu_adm, 2, ',', ' ') }}<b></td>
                        ...
                        <td><font color="{{ $info['color'] }}"><b>{{ number_format($info['result'][$i]['sum_cb'] + $info['result'][$i+1]['sum_cb'] + $info['result'][$i+2]['sum_cb'] + $cb_adm, 2, ',', ' ') }}<b></td>
                        ...
                        <td><font color="{{ $info['color'] }}"><b>{{ number_format($cb_adm, 2, ',', ' ') }}<b></td>
                    </tr>
                @else
                    <tr>
                        @php 
                        ...
                        <td>{{ number_format($info['result'][$i]['sum_fu'] + $info['result'][$i+1]['sum_fu'] + $info['result'][$i+2]['sum_fu'] + $fu_adm, 2, ',', ' ') }}</td>
                        ...
                        <td><font color="{{ $info['color'] }}">{{ number_format($info['result'][$i]['sum_cb'] + $info['result'][$i+1]['sum_cb'] + $info['result'][$i+2]['sum_cb'] + $cb_adm, 2, ',', ' ') }}</td>
                        ...
                        <td><font color="{{ $info['color'] }}">{{ number_format($cb_adm, 2, ',', ' ') }}</td>
                    </tr>
                @endif
            @endif        
        @endfor
        <tr>
            <th>Итог</th>
            <td></td>
            <td><b>{{ number_format($info['total'][0]['fu'] + $info['total'][1]['fu'] + $info['total'][2]['fu'] + $fu, 2, ',', ' ') }}<b></td>
            ...
            <td><font color="{{ $info['color'] }}"><b>{{ number_format($info['total'][0]['cb'] + $info['total'][1]['cb'] + $info['total'][2]['cb'] + $cb, 2, ',', ' ') }}<b></td>
