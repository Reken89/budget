...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td></td>
            <td></td>
            <td><font color="blue"><b>{{ $info['date'][26]['date_cb'] }}</b></td>
            <td><font color="blue"><b>{{ $info['date'][29]['date_cb'] }}</b></td>
            <td></td>
            <td><font color="blue"><b>{{ $info['date'][26]['date_fu'] }}</b></td>
            <td><font color="blue"><b>{{ $info['date'][29]['date_fu'] }}</b></td>
        </tr>
            ...
            @if(($i % 2) == 0 || $i == 0)
                @if($info['result'][$i]['ekr']['shared'] == "Yes" || $info['result'][$i]['ekr']['main'] == "Yes")
                    <tr>
                        ...
                        <td><b>{{ number_format($info['result'][$i]['sum_cb'] + $info['result'][$i+1]['sum_cb'], 2, ',', ' ') }}<b></td>
                        <td><b>{{ number_format($info['result'][$i]['sum_cb'], 2, ',', ' ') }}<b></td>
                        <td><b>{{ number_format($info['result'][$i+1]['sum_cb'], 2, ',', ' ') }}<b></td>
                        <td><font color="blue"><b>{{ number_format($info['result'][$i]['sum_fu'] + $info['result'][$i+1]['sum_fu'], 2, ',', ' ') }}<b></td>
                ...
                @else
                    <tr>
                        ...
                        <td>{{ number_format($info['result'][$i]['sum_cb'] + $info['result'][$i+1]['sum_cb'], 2, ',', ' ') }}</td>
                        ...
                        <td><font color="blue">{{ number_format($info['result'][$i]['sum_fu'] + $info['result'][$i+1]['sum_fu'], 2, ',', ' ') }}</td>
        ...
        <tr>
            <th>Итог</th>
            <td></td>
            <td><b>{{ number_format($info['total'][0]['cb'] + $info['total'][1]['cb'], 2, ',', ' ') }}<b></td>
            <td><b>{{ number_format($info['total'][0]['cb'], 2, ',', ' ') }}</b></td> 
            <td><b>{{ number_format($info['total'][1]['cb'], 2, ',', ' ') }}</b></td>  
            <td><font color="blue"><b>{{ number_format($info['total'][0]['fu'] + $info['total'][1]['fu'], 2, ',', ' ') }}<b></td>
