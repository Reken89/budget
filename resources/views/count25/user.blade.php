    ...
    <main class="main__content_wrapper">  
        ...
        <section class="my__account--section section--padding">
            ...
            <section class="shipping__section">
                <div class="container2">
                    <form id="smeta" action="/budget/public/user/count25" method="get">
                    <div class="shipping__inner style2 d-flex">
                        ...
                        <div class="shipping__items style2 d-flex align-items-center">
                            <div class="shipping__content">
                                ...
                                <br>
                                    <form action="/budget/public/user/count25/export" method="get">
                        ...
                        <div class="shipping__items style2 d-flex align-items-center">
                            <div class="about__content">
                                ...
                                <p class="about__content--desc mb-20"><b>Сформировать -</b> Формирует таблицу прогноза по выбранному разделу</br>
                                    <b>Отправить -</b> Завершить работу с таблицей</br>
