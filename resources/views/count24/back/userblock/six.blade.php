...
<table>
    ...
    <tbody>
        ...
        <tr>
            <th>Итог</th>
            <td></td>
            <td><b>{{ number_format($cb_school + $cb_garden, 2, ',', ' ') }}<b></td>
            <td><b>{{ number_format($cb_school, 2, ',', ' ') }}</b></td> 
            <td><b>{{ number_format($cb_garden, 2, ',', ' ') }}</b></td>  
            <td><font color="{{ $color }}"><b>{{ number_format($fu_school + $fu_garden, 2, ',', ' ') }}<b></td>
            <td><font color="{{ $color }}"><b>{{ number_format($fu_school, 2, ',', ' ') }}</b></td> 
            <td><font color="{{ $color }}"><b>{{ number_format($fu_garden, 2, ',', ' ') }}</b></td> 
        </tr>
    </tbody>
</table>
</html>
