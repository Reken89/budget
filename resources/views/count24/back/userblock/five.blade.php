...
<table>
    ...
    <tbody>
        ...
        <tr>
            <th>Итог</th>
            <td></td>
            <td><b>{{ number_format($cb_dhsh + $cb_dmsh, 2, ',', ' ') }}<b></td>
            <td><b>{{ number_format($cb_dhsh, 2, ',', ' ') }}</b></td> 
            <td><b>{{ number_format($cb_dmsh, 2, ',', ' ') }}</b></td>  
            <td><font color="{{ $color }}"><b>{{ number_format($fu_dhsh + $fu_dmsh, 2, ',', ' ') }}<b></td>
            <td><font color="{{ $color }}"><b>{{ number_format($fu_dhsh, 2, ',', ' ') }}</b></td> 
            <td><font color="{{ $color }}"><b>{{ number_format($fu_dmsh, 2, ',', ' ') }}</b></td> 
        </tr>
    </tbody>
</table>
</html>