...
<table>
    ...
    <tbody>
            ...
            @if(($i % 3) == 0 || $i == 0)
                @if($info[$i]['ekr']['shared'] == "Yes" || $info[$i]['ekr']['main'] == "Yes")
                    <tr>
                        ...
                        <td><b>{{ number_format($info[$i]['sum_cb'] + $info[$i+1]['sum_cb'] + $info[$i+2]['sum_cb'], 2, ',', ' ') }}<b></td>
                        ...
                        <td><font color="{{ $color }}"><b>{{ number_format($info[$i]['sum_fu'] + $info[$i+1]['sum_fu'] + $info[$i+2]['sum_fu'], 2, ',', ' ') }}<b></td>
                ...
                @else
                    <tr>
                        ...
                        <td>{{ number_format($info[$i]['sum_cb'] + $info[$i+1]['sum_cb'] + $info[$i+2]['sum_cb'], 2, ',', ' ') }}</td>
                            @if($info[$i]['status'] == '2')
                            ...
                            @endif
                        <td><font color="{{ $color }}">{{ number_format($info[$i]['sum_fu'] + $info[$i+1]['sum_fu'] + $info[$i+2]['sum_fu'], 2, ',', ' ') }}</td>
        ...
        <tr>
            <th>Итог</th>
            <td></td>
            <td><b>{{ number_format($cb_kums + $cb_uprav + $cb_edds, 2, ',', ' ') }}<b></td>
            <td><b>{{ number_format($cb_kums, 2, ',', ' ') }}</b></td> 
            <td><b>{{ number_format($cb_uprav, 2, ',', ' ') }}</b></td>  
            <td><b>{{ number_format($cb_edds, 2, ',', ' ') }}</b></td> 
            <td><font color="{{ $color }}"><b>{{ number_format($fu_kums + $fu_uprav + $fu_edds, 2, ',', ' ') }}<b></td>
            <td><font color="{{ $color }}"><b>{{ number_format($fu_kums, 2, ',', ' ') }}</b></td> 
            <td><font color="{{ $color }}"><b>{{ number_format($fu_uprav, 2, ',', ' ') }}</b></td> 
            <td><font color="{{ $color }}"><b>{{ number_format($fu_edds, 2, ',', ' ') }}</b></td> 
        </tr>
    </tbody>
</table>
</html>