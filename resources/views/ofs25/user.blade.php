    ...
    <main class="main__content_wrapper">
        ...
        <section class="my__account--section section--padding">
            <div class="container2">
                <form id="smeta" action="/budget/public/user/ofs25" method="get"> 
            ...
            <div class="container">
                ...
                <p><b><u>Сформировать</u></b> - Формирует таблицу, по выбранным параметрам</br>
                    ...
                    <font color='red'>*** Обращаем Ваше внимание, что процесс выполнения синхронизации может длится до 60 сек!</font> 
                </p>
...
<script>
    $(document).ready(function(){ 
        ...
        function fetch_data(){ 
            ...
            $.ajax({  
                url:"/budget/public/user/ofs25/table",  
                method:"GET",
                data:{
                    mounth, chapter, user
                },
