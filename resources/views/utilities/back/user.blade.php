                ...
                <div class="account__wrapper">
                    <div class="account__content">
                        ...
                        <p><b>*Ваш тариф</b> = Тариф получается в результате деления суммы на объем.</br>
                            Если цифра зеленого цвета, Вы укладываетесь в допустимый диапозон</p></br>
                        <p><b>Негативное воздействие</b> заполняется автоматически, на основе значений из водоотведения:</p>
                    </div>
                </div>
            </div>
        </div> 
