...
<html class="no-js" lang="zxx">
   ...
   <body>
                     ...
                     <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6 col-5">
                        <div class="logo">
                           <a href="/budget/public/home">
                              <img src="assets/img/logo/logo-5-black.png" alt="">
                           </a>
                        </div>
                     </div>
                     <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-6 col-sm-6 col-7">
                        <div class="header__bottom-right-5 d-flex justify-content-end align-items-center">
                           ...
                           <div class="header__btn-5 header__btn-12 ml-10">
                              <a href="/budget/public/home" class="d-none d-xl-inline-block">Информация</a>
                           </div>
                        </div>
                     </div>
                  </div>
      ...
      <main>
            ...
            <section class="page__title-area pt-145 pb-150 p-relative page__title-overlay" data-background="{{ asset('assets/img/page-title/page-title-1.jpg') }}">
               <div class="container">
                  <div class="row">
                     <div class="col-xxl-12">
                        <div class="page__title-wrapper">
                           ...
                           <nav aria-label="breadcrumb">
                              <ol class="breadcrumb">
                              <li class="breadcrumb-item"><a href="/budget/public/home">Главная</a></li>
                           ...
                           <ul class="mb-20">
                              ...
                              <li class="d-flex">
                                 ...
                                 <div class="contact__info-text">
                                    <p>Телефон</p>
                                    <h5>
                                       <a href="tel:+673-853-605-985">+7 911 662 54 78</a>
                                    </h5>
                                 </div>
                              </li>
                              <li class="d-flex">
                                 <div class="contact__info-icon mr-20">
                                    <img src="{{ asset('assets/img/icon/location.png') }}" alt="">
                                 </div>
                                 <div class="contact__info-text">
                                    <p>Адрес</p>
                                    <h5>
