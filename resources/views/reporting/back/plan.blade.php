...
<h3>Загрузите файл для таблицы "Исполнение МБТ"</h3>   
<form enctype="multipart/form-data" action="/budget/public/admin/mbt/upload" method="POST">
    @csrf
    <input name="file" id="file" type="file">
    <input type="submit" id="btn_one" class="btn btn-default" value="Загрузить">
...
<div class="shadowbox">
    <p>Таблица с информацией о наличие загруженных сведений "Исполнение МБТ"</p>
</div>
