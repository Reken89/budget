                                          ...
                                          <ul class="submenu">
                                             ...
                                             <li>
                                                <form action="{{ route('forecast25')}}" method="get">
                                                    <button type="submit" class="custom-btn btn-16">Прогноз услуг</button>
                                                </form>
                                             </li>
                                             <li>
                                                <form action="{{ route('admincount')}}" method="get">
                                                    ...
                                                    <button type="submit" class="custom-btn btn-16">Бюджет 2024-2026</button>
                                                </form>
                                             </li>  
                                             <li>
                                                <form action="{{ route('admincount24')}}" method="get">
                                                    ...
                                                    <button type="submit" class="custom-btn btn-16">Бюджет 2025-2027</button>
                                                </form>
                                             </li>
                                             <li>
                                             ...
                                             <li>
                                                 <form action="{{ route('usercount')}}" method="get">
                                                    <input type='hidden' name='variant' value='1'>
                                                    <input type='hidden' name='year' value='2024'>
                                                    <button type="submit" class="custom-btn btn-16"><b>Бюджет 2024-2026<b></button>
                                                </form>
                                             </li>  
                                             <li>
                                                <form action="{{ route('usercount24')}}" method="get">
                                                    <input type='hidden' name='variant' value='5'>
                                                    <input type='hidden' name='year' value='2025'>
                                                    <button type="submit" class="custom-btn btn-16"><b>Бюджет 2025-2027</b></button>
                                                </form>
                                             </li>    
                                             <li>
